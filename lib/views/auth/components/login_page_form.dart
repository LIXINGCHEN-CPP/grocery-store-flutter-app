                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: isPasswordShown
                            ? Colors.green.withOpacity(
                                0.1) // Background color when password is visible
                            : Colors
                                .transparent, // Transparent background when password is hidden
                      ...
                      child: SvgPicture.asset(
                        ...
                        colorFilter: ColorFilter.mode(
                          isPasswordShown
                              ? Colors
                                  .green // Icon color when password is visible
                              : Colors
                                  .grey, // Icon color when password is hidden
                          BlendMode.srcIn,
                        ),
                      ),
                    ),
